...
public class Velo extends Produit {
    ...
    public Velo(int id, String  marque, String type,String img_url) {
        super(id,img_url);
        this.marque = marque ;
        this.type = type ;
    ...
    public Velo(int id, String nomProduit, String description, float prix, int quantite, String img_url) {
