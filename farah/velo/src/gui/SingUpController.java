...
public class SingUpController implements Initializable {
    ...
    private void ajouter_utilisateur(ActionEvent event) throws SQLException, IOException {
        ...
        String req= "INSERT INTO fos_user (username,email,password,nom,prenom,date_naiss,tel,interets,image) VALUES (?,?,?,?,?,?,?,?,'fb.jpg')";
        ...
        {   info.setText("mot de passe n'est pas compatible");  }
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("../gui/Term.fxml"));
    ...
    private void ResetAll(ActionEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(getClass().getResource("../GUI/SingUp.fxml"));
        Parent root = loader.load();
