...
public class LoginController extends Controller implements Initializable {
    ...
    private void LoginAction(ActionEvent event) throws SQLException, IOException {
        ...
        if (!rs.next()){
            ...
            if (!remember.isSelected()){
                ...
                stage.close();
                Parent root = FXMLLoader.load(getClass().getResource("../gui/LayoutFront.fxml"));   
    ...
    public void SignUp(ActionEvent event) throws IOException{
        ...
        stage = (Stage)node.getScene().getWindow();
        stage.close();
        scene = new Scene(FXMLLoader.load(getClass().getResource("/gui/SignUp.fxml")));
        stage.setScene(scene);
        stage.show();
    }
    ...
    private void sendmail(ActionEvent event) throws IOException {
        ...
        stage = (Stage)node.getScene().getWindow();
        stage.close();
        scene = new Scene(FXMLLoader.load(getClass().getResource("../gui/ForgotPass.fxml")));
        stage.setScene(scene);
        stage.show();
    }
